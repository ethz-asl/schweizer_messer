...
TEST(SerializationMacros, TestClassHasMethodDeduction) {
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<ComplexEntry>::value, 1);
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<SimpleEntry>::value, 0);
}
...
TEST(SerializationMacros, TestClassSharedPtrHasMethodDeduction) {
  ...
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<T1>::value, 1);
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<T2>::value, 0);

  T1 t1;
  T2 t2;

  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<decltype(t1) >::value, 1);
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<decltype(t2) >::value, 0);

  T1& t1r = t1;
  T2& t2r = t2;

  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<decltype(t1r) >::value, 1);
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<decltype(t2r) >::value, 0);

  const T1& t1cr = t1;
  const T2& t2cr = t2;

  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<sm::common::StripConstReference<decltype(t1cr)>::result_t >::value, 1);
  ASSERT_EQ(sm_serialization::internal::HasIsBinaryEqual<sm::common::StripConstReference<decltype(t2cr)>::result_t >::value, 0);
...
TEST(SerializationMacros, TestClassHasStreamOperator) {
  ...
  sm_serialization::internal::streamIf<sm_serialization::internal::HasOStreamOperator<std::ostream, decltype(e1)>::value, decltype(e1) >::eval(e1);

  ASSERT_EQ((sm_serialization::internal::HasOStreamOperator<std::ostream, SimpleEntry>::value), 1);
  ASSERT_EQ((sm_serialization::internal::HasOStreamOperator<std::ostream, ComplexEntry>::value), 0);
}
...
TEST(SerializationMacros, TestSharedPtrHasStreamOperator) {
  ...
  sm_serialization::internal::streamIf<sm_serialization::internal::HasOStreamOperator<std::ostream, T1>::value, T1 >::eval(e1);

  ASSERT_EQ((sm_serialization::internal::HasOStreamOperator<std::ostream, T2>::value), 1);
  ASSERT_EQ((sm_serialization::internal::HasOStreamOperator<std::ostream, T1>::value), 0);
}
...
TEST(SerializationMacros, TestClassCTPolyHasMethodDeduction) {
  ...
  ASSERT_TRUE(sm_serialization::internal::HasIsBinaryEqual<T1>::value);
  ASSERT_TRUE(sm_serialization::internal::HasIsBinaryEqual<T2>::value);
  ASSERT_FALSE(sm_serialization::internal::HasIsBinaryEqual<T3>::value);
  ASSERT_FALSE(sm_serialization::internal::HasIsBinaryEqual<T4>::value);
  ASSERT_TRUE(sm_serialization::internal::HasIsBinaryEqual<T5>::value);
  ASSERT_TRUE(sm_serialization::internal::HasIsBinaryEqual<T6>::value);
  ASSERT_FALSE(sm_serialization::internal::HasIsBinaryEqual<T7>::value);
  ASSERT_FALSE(sm_serialization::internal::HasIsBinaryEqual<T8>::value);
}
